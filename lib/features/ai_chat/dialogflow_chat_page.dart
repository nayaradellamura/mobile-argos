...
class DialogflowChatPage extends StatefulWidget {
  const DialogflowChatPage({super.key});
...
''';
  ...
  Widget build(BuildContext context) {
    return const Scaffold(
      ...
      body: SafeArea(child: _DialogflowWebView()),
    );
  }
}

class _DialogflowWebView extends StatefulWidget {
  const _DialogflowWebView();

  @override
  State<_DialogflowWebView> createState() => _DialogflowWebViewState();
}

class _DialogflowWebViewState extends State<_DialogflowWebView> {
  late final WebViewController controller;
